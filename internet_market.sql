...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 06 2021 г., 14:48
...
CREATE TABLE `item` (
  `id` int(11) NOT NULL,
  `id_category` int(11) NOT NULL COMMENT 'id категории товара',
...
CREATE TABLE `item_orderat` (
  `id` int(11) NOT NULL,
  `id_orderat` int(11) NOT NULL COMMENT 'id заказа',
  `id_items` int(11) NOT NULL COMMENT 'id товара',
  `number` int(11) NOT NULL COMMENT 'Колличество',
  `price` float NOT NULL COMMENT 'Цена'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Товар заказа';
...
CREATE TABLE `orderat` (
  `id` int(11) NOT NULL,
  `id_customer` int(11) NOT NULL COMMENT 'id покупателя',
...
CREATE TABLE `payment` (
  ...
  `sum` int(11) NOT NULL COMMENT 'Сумма'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Оплата';
